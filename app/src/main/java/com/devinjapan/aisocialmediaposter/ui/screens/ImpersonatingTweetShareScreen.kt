...
import com.devinjapan.aisocialmediaposter.ui.viewmodels.TweetImpersonificationViewModel
import kotlinx.coroutines.launch

@SuppressLint("UnusedMaterialScaffoldPaddingParameter")
@Composable
fun ImpersonatingTweetShareScreen(
    navController: NavController,
    viewModel: TweetImpersonificationViewModel,
...
@Composable
private fun DescriptionInputTextField(viewModel: CaptionGeneratorViewModel) {
